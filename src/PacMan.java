...
public class PacMan extends JFrame implements ActionListener
{
  ...
  /*Hay 5 solicitudes posibles al controlador del juego: 
   *  Iniciar (o conectarse). (opt 1)
   *  Moverse en alguna dirección.(2 izq, 3 arriba, 4 der, 5 abajo)
   *  
   *  La respuesta del servidor deberia ser un arreglo de objetos:
   *  (boolean) Esta jugando o no
   *  (int) vidas restantes
   *  (int) hacia donde mira ahora pacman
   *  (int)x N las nuevas posiciones del pacman y fantasmas
   *  
  ...
  {
	/*Este metodo es al parecer el que se encarga de refrescar la pantalla, su 
	 * firma al parecer es obligatoria, aproveche dentro de este metodo para 
	 * obtener el Graphics de el Jpanel Board (el tablero del juego) y en este 
	 * momento dibujar a pacman y los fantasmas segun las posiciones que hay 
	 * almacenadas "localmente" (en la instancia de esta clase)
	 * 
	 * */
  ...
  /*Esta subClase (no se el nombre tecnico que llevan estas cosas xD)
   * es la que se encarga de manejar los inputs del teclado:*/
  class TAdapter extends KeyAdapter {
    ...
    public void actionPerformed(ActionEvent e) {
    	 ...
    	 * implementacion antigua para la parte grafica, pero creo que funciona asi:
    	 *  Cada 40 milisegundos (el timer) se llama a este metodo, el cual solo 
    	 *  llama a repaint, este a su vez, llama a paint() de todos los elementos
    	 *  graficos de la interfaz, partiendo (supongo) por el JFrame padre.
    	 *  Paint() (para el jFrame) esta redefinido arriba, segun lo que lei, este
    	 *  metodo no debería ser llamado directamente, pero bueh!, la cosa funciona.
    	 *  
    	 */
        repaint();  
    }
